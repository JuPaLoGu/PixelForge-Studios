...
<body>
    ...
    <div class="topbar">
        ...
        <div class="topbar-left">
            <label>Cursos<br>virtuales</label>
        </div>
    ...
    <nav class="mobile-menu" id="mobileNav">
        <a href="Metas_Empleados.php">Cursos virtuales</a>
        <a href="Contratacion.php">Contrato</a>
        <a href="Beneficios_Metas.php">Programas de bienestar</a>
    </nav>
